...
const Error = () => {
  return (
    <div className="w-11/12 mx-auto flex flex-col items-center justify-center dark:bg-black min-h-screen  px-4">
      <div className="bg-red-200 shadow-2xl rounded-3xl p-8 md:p-16 text-center w-full max-w-md">
